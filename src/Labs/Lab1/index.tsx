    ...
    return (
      <div id="wd-lab1">
        ...
        <div id="wd-p-tag">
            ...
            white spaces and render all the text as one single set of sentences. To force 
            the browser to add vertical spacing, wrap the paragraphs you want to 
        ...
        <div id="wd-lists">
            ...
            <ol id="wd-your-favorite-recipe">
                ...
                <li>¼ teaspoon salt</li>
                <li>1 ¼ cups (300ml) buttermilk (or regular milk with 1 tablespoon vinegar/lemon juice)</li>
                <li>1 large egg</li>
        ...
        <div id="wd-images">
            ...
            <br />
            <img id="wd-teslabot" src="images/teslabot.jpg" height="200px" alt="tesla" />
        </div>
